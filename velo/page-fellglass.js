    ...
    if (msg.type === 'ready') {
      ...
      try {
        await saveCombatDeclare(msg.charId || charId, {
          act: msg.act, react: msg.react, target: msg.target, round: msg.round, dmg: msg.dmg, base: msg.base, dt: msg.dt, fellmark: msg.fellmark, doubleFell: msg.doubleFell, applies: msg.applies, actTier: msg.actTier,
